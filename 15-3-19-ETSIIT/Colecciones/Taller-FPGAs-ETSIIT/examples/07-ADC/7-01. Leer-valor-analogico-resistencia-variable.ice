    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## 7-01. Leer el valor analógico de una resistencia variable\n\nConectar una resistencia variable lineal de 10K al canal 0 del conversor A/D y leer  \nsu valor digital, de 8 bits, que mostraremos en los LEDs de la Icezum Alhambra.",
            "readonly": true
          },
          "position": {
            "x": 328,
